...
GUI::GUI()
{
	...
	yStatusBar_changable = 1.5;//hannah
	check = 0;
	//**********************************
...
void GUI::PrintMessage(string msg, int move) const	//Prints a message on status bar
{
	if (move == 0)
	{
	...
	else if (move == 3)
	{
		pWind->SetPen(DARKRED);
		pWind->SetFont(18, BOLD, BY_NAME, "Arial");
		pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 2.7), msg);
	}
	...
	else if (move == 4)
	{
		pWind->SetPen(DARKRED);
		pWind->SetFont(18, BOLD, BY_NAME, "Arial");
		pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 4.5), msg);
	}
}
//*****************************************************************************

/*void GUI::PrintNewLine(string msg)   //Hannah
{
	if (check == 2)
	{
		yStatusBar_changable = 1.5;
		check = 0;
	}
	yStatusBar_changable = yStatusBar_changable + 0.5;
	pWind->SetPen(DARKRED);
	pWind->SetFont(18, BOLD, BY_NAME, "Arial");
	if ((WindHeight - (int)(StatusBarHeight / yStatusBar_changable)) >= WindHeight)
		return;
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / yStatusBar_changable), msg);
	check++;
}*/
//***********************************************************************************
//////////////////////////////////////////////////////////////////////////////////////////
