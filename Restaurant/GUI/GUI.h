...
private:
	...
	//*************************************************************************
	double yStatusBar_changable;
	int check;// to check is printiMessage is called then we have to reset yStatusBar_changable
...
public:
	...
	// Output Functions  ---------------------------
	void PrintMessage(string msg, int move=0) const; // prints a message in the status bar
	//**********************************************************************************
	//void PrintNewLine(string msg);
	//**********************************************************************************
