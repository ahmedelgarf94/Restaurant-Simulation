...
public :
	...
	inline void SortOrdersByArrivalTime(Queue<Order*> OrderQueue);
	~Queue();
};
/////////////////////////////////////////////////////////////////////////////////////////
...
/*inline void Queue<Order*>::SortOrdersByArrivalTime(Queue<Order*> OrderQueue)
{

	Node<Order*>* p = OrderQueue.frontPtr;
	if (p == nullptr)
		return;
	...
	p = OrderQueue.frontPtr;
	Node<Order*>* ptr = p->getNext();
	for (int i = 0; i < count; i++)
	{
		while (ptr)
		{
			if (p->getItem()->GetID() > ptr->getItem()->GetID())
			{
				temp = p->getItem();
